<template>
  <div class="report-container">
    <table border="0" cellspacing="1" bgcolor="#999999" width="1100">
      <tr>
        <td colspan="11" align="center" bgcolor="#EEEEEE">
          <font size="3">
            民國{{year - 1911}}年 {{periodType === 1 ? '上期' : '下期'}}
            開徵礦業權費及礦產權利金有權利金明細({{periodType === 1 ? `起徵日: 民國${year - 1911}年/4/1` : `起徵日: 民國${year - 1911}年/10/1`}})
          </font>
        </td>
      </tr>
      <tr>
      ...
      <div v-else>
        <td colspan="11" align="center" bgcolor="#EEEEEE">查無資料</td>
      </div>
    </table>
  </div>
</template>
...
@Component
export default class Report200 extends Vue {
