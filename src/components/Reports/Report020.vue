<template>
  <div class="report-container">
    <table border="0" cellspacing="1" bgcolor="#999999" width="1100">
      <tr>
        <td
          :colspan="4 + data.items[0].reportPeroidTax.length * 2 + 5"
          align="center"
          bgcolor="#EEEEEE"
        >
          <font size="3">
            民國{{startYear - 1911}}年 {{startPeriodType === 1 ? '上期' : '下期'}} ~ 民國{{endYear - 1911}}年 {{endPeriodType === 1 ? '上期' : '下期'}}
            開徵礦業權費及礦產權利金開徵明細({{endPeriodType === 1 ? `起徵日: 民國${endYear - 1911}年/4/1` : `起徵日: 民國${endYear - 1911}年/10/1`}})
          </font>
        </td>
      </tr>
      <tr>
...
@Component
export default class Report020 extends Vue {
  @Prop() public data!: string
  @Prop() public startYear!: string
  @Prop() public endYear!: string
  @Prop() public startPeriodType!: number
  @Prop() public endPeriodType!: number
